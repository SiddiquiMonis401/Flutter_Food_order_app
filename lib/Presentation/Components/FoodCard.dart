...
class FoodCard extends StatelessWidget {
  ...
  const FoodCard({Key key, this.cardData}) : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(children: [
                    for (var i = 0; i < 5; i++)
                      Icon(
                        i < cardData.rating ? Icons.star : Icons.star_border,
                        ...
                        child: Container(
                          child: Align(
                              ...
                              child: InkWell(
                                onTap: () {
                                  onAddItemToCart(
                                      FoodCartData(cardData.foodName, cardData.foodPrice, 1), context);
                                },
                                child: Icon(
                                  Icons.add,
                                  size: 20,
